...
from MOS_Detection import MOS_rules_paper as mrp
from HumanSensing_Preprocessing import data_loader as dl


#  set path where the humansensing-app.py file is located
...
# data file to test:
#data_file_test = "C:/Users/MM/Desktop/Uni Salzburg/P.hD/ZGis/Human Sensing/MOS_Detection/MOS_algo_Martin/Data_MOS/KIT_Fon_06_Freddy_2022-06-30T0858.sqlite"


#data_load_state = st.text('Loading data...')
#data = pd.read_csv("../MOS_Detection/MOS_output.csv")

#data = signal_data.copy()

#mos_data = pd.read_csv("../MOS_Detection/zgis_phone_3_2021-08-25T1430_mos_candidates.csv")
#mos_data['latitude']=pd.to_numeric(mos_data['latitude'])
#mos_data['longitude']=pd.to_numeric(mos_data['longitude'])
...
if st.sidebar.button("Generate MOS"):
    ...
    final_MOS_output = mrp.MOS_Detection_Paper_main(data = data)
...
if st.button("Download MOS as .csv"):
    ...
    st.write("Saved file as", uploaded_data_files.name + ".csv")
